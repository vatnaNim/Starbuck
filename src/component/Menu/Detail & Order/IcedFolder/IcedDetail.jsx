      ...
      <div className="max-w-full grid grid-rows-1 md:grid-cols-2 py-12 bg-[#1e3932] ">
        <article className="sm:max-w-full max-w-full flex justify-center items-center">
          <img
            ...
            src="https://globalassets.starbucks.com/digitalassets/products/bev/TropicalCitrusEnergyDrink.jpg?impolicy=1by1_wide_topcrop_630"
            alt="image product"
          />
        </article>
